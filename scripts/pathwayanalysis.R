...
deg <- read.csv2("data/230620_deseq2results.csv")
...
ggsave("results/pdf/kegg_diseasepathways.pdf", width = 15, height = 5)
ggsave("results/svg/kegg_diseasepathways.svg", width = 15, height = 5)
...
ggsave("results/pdf/kegg_sigmet.pdf", width = 15, height = 5)
ggsave("results/svg/kegg_sigmet.svg", width = 15, height = 5)

# Overlay the expression data onto this pathway
pathview(gene.data=foldchanges, species="hsa", pathway.id="hsa01522")

# Overlay the expression data onto this pathway
pathview(gene.data=foldchanges, species="hsa", pathway.id="hsa01522", kegg.native=FALSE)
